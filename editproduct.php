...
include('header.php');
$id=$_REQUEST['id'];
$prod=mysql_fetch_array(mysql_query("SELECT p.productname as pname from products p where id='$id'"));
//get product TYPES
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form id="form-wizard" action="patientclass.php?action=editproduct&&id=<?php echo $id?>" class="form-horizontal" method="post">
              <div id="form-wizard-1" class="step">
                         
                <div class="control-group">
                  <label class="control-label">Product Name</label>
                  <div class="controls">
                    <input id="text" type="text" name="name"  value="<?php echo $prod['pname']?>" />
                  </div>
                </div>
                  <div class="control-group">
