...
?>
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="brands.php">Brands</a> <a href="#" class="current">Add Brands</a> </div>
    <h1>Add Brand</h1>
  </div>
