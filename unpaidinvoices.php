<?php
include('header.php');
$query="SELECT inv.id as id, inv.totalcost as tot ,inv.dateadded as dateadded,p.name as name , p.tel as tel from invoices inv inner join patients p on p.id=inv.patientid where inv.status='0' order by  inv.dateadded  asc";
